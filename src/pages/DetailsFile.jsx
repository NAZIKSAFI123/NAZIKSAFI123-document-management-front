...
import { getDocumentById, deleteDocument } from "../api/documentsApi";
      ...
      <div className="flex flex-wrap w-full max-w-screen-lg">
        ...
        />
            ...
            <div className="flex flex-col lg:flex-row items-center">
              <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded mb-2 lg:mb-0 lg:mr-2" onClick={handleDownload}>
                Télécharger
              </button>
          ...
          <h3 className="text-lg font-semibold mb-2">Détails du document</h3>
              <div className="border-b border-gray-400 opacity-50 mb-6"></div>
               ...
               <BsFiletypeDocx/>
                ...
                <input type="text" id="name" value={documentData.name} className="rounded-none rounded-r-lg  border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Name" />
              </div>
              <div className="flex mb-4">
                <span className="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                  <SiZaim/>
                </span>
                <input type="text" id="size" value={documentData.metadata ? documentData.metadata.size : ''}className="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Size" disabled/>
              </div>
                  </div>
                  <div className="mb-4">
                  <div className="flex mb-4">
                ...
                <input type="text" id="user" className="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="La dernière mise à jour a été effectuée par" disabled/>
              </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div className="flex mb-4">
             ...
             <MdDateRange/>
                ...
                <input type="text" id="datec" value={documentData.creationDate} className="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Créé à" disabled />
              </div><div className="flex mb-4">
                <span className="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                <MdDateRange/>
                </span>
                <input type="text" id="datem" value={documentData.creationDate} className="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="modifier à" disabled/>
              </div>
                  </div>
                  <div className="mb-4">
                  <div className="flex mb-4">
                ...
                <input type="text" id="url" value={documentData.storageLocation} className="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="URL" disabled/>
              </div>
                  </div>
                  <div className="mb-4">
